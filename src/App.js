    ...
    return (
        <main>
            ...
            <section className="projects" id="portfolio">
                ...
                <Portfolio site="1" screenshot={stegatoScreenshot} logo={stegatoLogo} projectname="stegato" description="My inspiration for Stegato started from IMDB's top 250. I created a project that users can rate their favorite (and least favorite) albums and those ratings across the application are collected in the Stegato leaderboard. Features that I am currently working on to add to this application include Facebook login and a leaderboard that updates in real-time using websockets." technologies="html" applink="http://stegato.netlify.com/" repolink="https://github.com/JesseShawCodes/stegato"/>
